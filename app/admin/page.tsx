  ...
  return (
    <main className="min-h-screen bg-[var(--background)] pt-28 pb-16">
      <div className="container-shell">
        <div className="mb-6 flex items-center gap-3 rounded-xl border border-amber-300/20 bg-amber-300/[0.06] p-4 text-sm text-[var(--warning)]">
          <LockKeyhole size={18} className="shrink-0 text-[var(--warning)]" />
          <p>
        ...
        <div className="grid overflow-hidden rounded-3xl border border-[var(--border)] bg-[var(--surface)] lg:min-h-[680px] lg:grid-cols-[230px_1fr]">
          <aside className="border-b border-[var(--border)] p-6 lg:border-r lg:border-b-0">
            ...
            <p className="mt-8 text-sm leading-7 text-[var(--muted)]">
              This preview shows public project data only. Project editing,
              inquiry management, and settings are not connected.
            </p>
          </aside>
          <section className="p-5 sm:p-8">
            ...
            <div className="mt-7 grid gap-5 xl:grid-cols-2">
              ...
              <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface-elevated)]/45 p-6">
                ...
                <div className="mt-5 grid min-h-48 place-items-center rounded-xl border border-dashed border-[var(--border)] text-center text-sm text-[var(--foreground-muted)]">
                  Inquiry viewing is not implemented. Authentication and a
                  connection to the existing contact records are required before
                  this area can display inquiries.
                </div>
              </div>
            </div>
          </section>
