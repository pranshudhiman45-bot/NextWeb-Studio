...
export const siteConfig = {
  ...
  description:
    "NextWeb Studio is an independent development studio by Vinay Kumar, building modern websites, full-stack applications, SaaS products, e-commerce platforms and AI-powered experiences.",
  positioning:
